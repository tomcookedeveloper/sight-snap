...
function selectLayout(workingWidth, workingHeight) {
    ...
    let sizes = [{ "width": 4, height: 8, score: 3 }, { "width": 8, height: 4, score: 3 }];
...
function applyColours() {
    let panels = document.querySelectorAll(".darkMode, body, html, .button, .settingsButton, .panel, .note, .button");
